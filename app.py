...
SUBJECTS = {
    'svt': {'name': 'SVT', 'tutor': 'Prof. Ibn al-Nafis', 'emoji': '🧬', 'tutor_emoji': '👨‍🏫'},
    'math': {'name': 'Mathématiques', 'tutor': 'Prof. Omar Khayyam', 'emoji': '📐', 'tutor_emoji': '👨‍🏫'},
    'physics': {'name': 'Physique-Chimie', 'tutor': 'Prof. Ibn al-Haytham', 'emoji': '⚗️', 'tutor_emoji': '👨‍🏫'},
    'philosophy': {'name': 'Philosophie', 'tutor': 'Prof. Ibn Rushd (Averroès)', 'emoji': '📖', 'tutor_emoji': '👩‍🏫'},
    'arabic': {'name': 'Langue Arabe', 'tutor': 'Prof. Sibawayh', 'emoji': '✍️', 'tutor_emoji': '👨‍🏫'},
    'english': {'name': 'Anglais', 'tutor': 'Prof. Edward Said', 'emoji': '🌐', 'tutor_emoji': '👨‍🏫', 'custom_image': 'BigBen.png'},
    'french': {'name': 'Français', 'tutor': 'Prof. Taha Hussein', 'emoji': '🗼', 'tutor_emoji': '👨‍🏫'},
    'islamic': {'name': 'Éducation Islamique', 'tutor': 'Prof. Imam Malik', 'emoji': '🕌', 'tutor_emoji': '👨‍🏫'},
    'social': {'name': 'Histoire-Géographie', 'tutor': 'Prof. Ibn Khaldoun', 'emoji': '🌍', 'tutor_emoji': '👨‍🏫'},
    'science': {'name': 'Éveil Scientifique', 'tutor': 'Prof. Al-Jahiz', 'emoji': '🔬', 'tutor_emoji': '👨‍🏫'},
    'communication': {'name': 'Expression et Communication', 'tutor': 'Prof. Al-Hariri', 'emoji': '🗣️', 'tutor_emoji': '👨‍🏫'},
    'motor': {'name': 'Activités Sensori-Motrices', 'tutor': 'Coach Abbas Ibn Firnas', 'emoji': '🏃‍♂️', 'tutor_emoji': '👨‍🏫'},
    'art_preschool': {'name': 'Arts Plastiques', 'tutor': 'Prof. Yahya Al-Wasiti', 'emoji': '🎨', 'tutor_emoji': '👨‍🏫'},
    'math_basic': {'name': 'Initiation aux Maths et Écriture', 'tutor': 'Prof. Al-Battani', 'emoji': '🔢', 'tutor_emoji': '👨‍🏫'},
    'islamic_basic': {'name': 'Éducation Islamique de Base', 'tutor': 'Prof. Imam Al-Ghazali', 'emoji': '🌙', 'tutor_emoji': '👨‍🏫'},
    'art_primary': {'name': 'Éducation Artistique', 'tutor': 'Prof. Yahya Al-Wasiti', 'emoji': '🎨', 'tutor_emoji': '👨‍🏫'},
    'pe': {'name': 'Éducation Physique (EPS)', 'tutor': 'Coach Tariq Ibn Ziyad', 'emoji': '⚽', 'tutor_emoji': '👨‍🏫'},
    'family_edu': {'name': 'Éducation Familiale', 'tutor': 'Prof. Fatima al-Fihriya', 'emoji': '👨‍👩‍👧‍👦', 'tutor_emoji': '👩‍🏫'},
    'informatique': {'name': 'Informatique', 'tutor': 'Prof. Al-Khwarizmi', 'emoji': '💻', 'tutor_emoji': '👨‍🏫'},
    'technology': {'name': 'Technologie Industrielle', 'tutor': 'Prof. Al-Jazari', 'emoji': '⚙️', 'tutor_emoji': '👨‍🏫'},
    'art_music': {'name': 'Éducation Musicale et Plastique', 'tutor': 'Prof. Ziryab', 'emoji': '🎵', 'tutor_emoji': '👨‍🏫'},
    'history_geo': {'name': 'Histoire-Géographie', 'tutor': 'Prof. Al-Idrisi', 'emoji': '🗺️', 'tutor_emoji': '👨‍🏫'},
    'economics': {'name': 'Économie et Comptabilité', 'tutor': 'Prof. Al-Maqrizi', 'emoji': '📊', 'tutor_emoji': '👨‍🏫'}
}
