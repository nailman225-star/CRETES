...
SUBJECTS = {
    ...
    'philosophy': {'name': 'Philosophie', 'tutor': 'Prof. Averroès (Ibn Rushd)', 'emoji': '📖', 'tutor_emoji': '👩‍🏫'},
    'arabic': {'name': 'Langue Arabe', 'tutor': 'Prof. Aicha El Bounia', 'emoji': '✍️', 'tutor_emoji': '👩‍🏫'},
    'english': {'name': 'Anglais', 'tutor': 'Prof. Maya', 'emoji': '🌐', 'tutor_emoji': '👩‍🏫', 'custom_image': 'BigBen.png'},
    'french': {'name': 'Français', 'tutor': 'Prof. Molière', 'emoji': '🗼', 'tutor_emoji': '👨‍🏫'},
    'islamic': {'name': 'Éducation Islamique', 'tutor': 'Prof. Malik', 'emoji': '🕌', 'tutor_emoji': '👨‍🏫'},
    'social': {'name': 'Histoire-Géographie', 'tutor': 'Prof. Ibn Khaldoun', 'emoji': '🌍', 'tutor_emoji': '👨‍🏫'},
    'science': {'name': 'Éveil Scientifique', 'tutor': 'Prof. Meryem', 'emoji': '🔬', 'tutor_emoji': '👩‍🏫'},
    'communication': {'name': 'Expression et Communication', 'tutor': 'Prof. Fatima', 'emoji': '🗣️', 'tutor_emoji': '👩‍🏫'},
    'motor': {'name': 'Activités Sensori-Motrices', 'tutor': 'Coach Tariq', 'emoji': '🏃‍♂️', 'tutor_emoji': '👨‍🏫'},
    'art_preschool': {'name': 'Arts Plastiques', 'tutor': 'Prof. Picasso', 'emoji': '🎨', 'tutor_emoji': '👨‍🏫'},
    'math_basic': {'name': 'Initiation aux Maths et Écriture', 'tutor': 'Prof. Omar', 'emoji': '🔢', 'tutor_emoji': '👨‍🏫'},
    'islamic_basic': {'name': 'Éducation Islamique de Base', 'tutor': 'Prof. Khadija', 'emoji': '🌙', 'tutor_emoji': '👩‍🏫'},
    'art_primary': {'name': 'Éducation Artistique', 'tutor': 'Prof. Laila', 'emoji': '🎨', 'tutor_emoji': '👩‍🏫'},
    'pe': {'name': 'Éducation Physique (EPS)', 'tutor': 'Coach Said', 'emoji': '⚽', 'tutor_emoji': '👨‍🏫'},
    'family_edu': {'name': 'Éducation Familiale', 'tutor': 'Prof. Al-Shifa', 'emoji': '👨‍👩‍👧‍👦', 'tutor_emoji': '👩‍🏫'},
    ...
    'art_music': {'name': 'Éducation Musicale et Plastique', 'tutor': 'Prof. Farid', 'emoji': '🎵', 'tutor_emoji': '👨‍🏫'},
    'history_geo': {'name': 'Histoire-Géographie', 'tutor': 'Prof. Al-Idrisi', 'emoji': '🗺️', 'tutor_emoji': '👨‍🏫'},
    'economics': {'name': 'Économie et Comptabilité', 'tutor': 'Prof. Adam Smith', 'emoji': '📊', 'tutor_emoji': '👨‍🏫'}
}
